...
L_g = 2estimate_lipschitz_constant(M, g, p0)
λ_D = 3/(2estimate_lipschitz_constant(M, g, p0))
```
...
@time pg = proximal_gradient_method(
	...
	prox_h, 
	p0;
	stepsize=ProxGradBacktracking(; strategy=:convex, initial_stepsize=3/2*λ_D),
	record=[:Iteration, :Cost, :Iterate],
	return_state=true,
	stopping_criterion=StopWhenGradientMappingNormLess(atol),
)
