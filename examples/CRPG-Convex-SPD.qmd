...
for n in spd_dims
    ...
    # Optimization
    pgm_constant = proximal_gradient_method(M, f_spd, g, grad_g, prox_h_spd, p0; pgm_bm_kwargs_constant(initial_stepsize)...)
    ...
    # Benchmarking
    if benchmarking
        pgm_constant_bm = @benchmark proximal_gradient_method($M, $f_spd, $g, $grad_g, $prox_h_spd, $p0; $pgm_bm_kwargs_constant($initial_stepsize)...)
