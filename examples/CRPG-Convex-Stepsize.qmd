...
function estimate_lipschitz_constant(M, g, anchor, R=D/2, N=100_000)
    constants = []
    for i in 1:N
 ...
 function theoretical_lipschitz_constant(M, g, anchor, R=D/2, N=100_00)
    constants = []
    for i in 1:N
        p = close_point(M, anchor, R)
...
est_1 = [estimate_lipschitz_constant(M, g, p0, D/2) for _ in 1:1000]
...
λ_D = 1/L_g
# Check if the stepsize is valid
(λ_D ≤ min(r/τ, λ_r)) && print("true")
```
