...
# | code-fold: true
# | output: asis
benchmarking && pretty_table(df_results_time_iter; tf = tf_markdown, header = column_names)
```
...
# | code-fold: true
# | output: asis
benchmarking && pretty_table(df_results_obj_spar; tf = tf_markdown, header = column_names)
```
