...
α = 3/2N # weight for the median component (h)
hn_dims = [1, 2, 5, 10, 15]
spd_dims = [2, 5, 10, 15]
```
...
We can take a look at how the algorithms compare to each other in their performance with the following table, where columns 2 to 4 relate to the RPGM, while columns 5 to 7 refer to the CPPA...
```{julia}
#| echo: false
#| code-fold: true
