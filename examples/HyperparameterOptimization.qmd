...
Hyperparameter optimization relies on the Optina Python library because it is much more advanced than similar Julia projects, offering Bayesian optimization with conditional fields and early stopping.
...
function lbfgs_study(; pruning_coeff::Float64=0.95)
    ...
    study.optimize(od; n_trials=100, timeout=150)
