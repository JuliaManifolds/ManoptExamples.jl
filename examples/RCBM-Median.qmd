...
#| code-fold: true
#| output: asis
benchmarking && pretty_table(A1, backend = :markdown, column_labels = col_names_1)
```
...
#| code-fold: true
#| output: asis
benchmarking && pretty_table(A2; backend = :markdown, column_labels = col_names_2)
```
...
#| code-fold: true
#| output: asis
benchmarking && pretty_table(A2_SPD; backend = :markdown, column_labels = col_names_2)
```
...
#| code-fold: true
#| output: asis
benchmarking && pretty_table(A1_Sn, backend = :markdown, column_labels = col_names_1)
```
... Whereas the following table refers to the SGM
```{julia}
#| echo: false
#| code-fold: true
#| output: asis
benchmarking && pretty_table(A2_Sn, backend = :markdown, column_labels = col_names_2)
```
