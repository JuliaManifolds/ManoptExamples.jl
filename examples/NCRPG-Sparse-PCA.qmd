...
df_results_ManPG    = DataFrame([name => Float64[] for name in list], makeunique=true)
#
...
#| code-fold: true
#| output: asis
header_1 = ["μ", "n", "p", "NCRPGconst_time", "NCRPGconst_iter", "NCRPGbt_time", "NCRPGbt_iter", "RPG_time", "RPG_iter", "ManPG_time", "ManPG_iter"]
...
#| code-fold: true
#| output: asis
header_2 = ["μ", "n", "p", "NCRPGconst_obj", "NCRPGconst_spar", "NCRPGconst_orth", "NCRPGbt_obj", "NCRPGbt_spar", "NCRPGbt_orth", "RPG_obj", "RPG_spar", "RPG_orth", "ManPG_obj", "ManPG_spar", "ManPG_orth"]
