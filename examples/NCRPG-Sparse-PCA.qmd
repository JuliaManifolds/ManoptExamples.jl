...
benchmarking && pretty_table(df_results_time_iter; backend = Val(:markdown), column_labels = header_1)
```
...
benchmarking && pretty_table(df_results_obj_spar_orth; backend = Val(:markdown), column_labels = header_2)
```
