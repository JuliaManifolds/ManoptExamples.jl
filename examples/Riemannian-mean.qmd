...
For this first example, the objective is a very common one, for example also used in the [🏔️ Get started with Manopt.jl](https://manoptjl.org/stable/tutorials/Optimize!/) tutorial of [Manopt.jl](https://manoptjl.org/).
...
we again refer to [🏔️ Get started with Manopt.jl](https://manoptjl.org/stable/tutorials/Optimize!/).
