...
We can defined both the cost and gradient, [`RiemannianMeanCost`](@ref) and [`RiemannianMeanGradient!!`](@ref), respectively.
...
Here, we want to specify that the objective can do inplace-evaluations using the `evaluation=`-keyword.
