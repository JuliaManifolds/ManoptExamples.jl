...
if export_csv
  CSV.write(
    "LM-Robust-Procrustes-Results.csv",
    DataFrame(;
      d = matrix_sizes, dim = manifold_dimensions, n = num_columns,
      t1 = mean_time_rLM, t2 = mean_time_LTMADS,
      f1 = final_cost_rLM, f2 = final_cost_LTMADS,
      iter1 = iterations_rLM, iter2 = iterations_LTMADS,
    )
  )
end
````
...
ax2 = Axis(fig2[1, 1], xlabel = "manifold dimension", ylabel = "final cost", title = "Cost value comparison")
scatterlines!(ax2, manifold_dimensions, final_cost_LTMADS; color = ltmads_color, label = "LTMADS", marker = :rect)
scatterlines!(ax2, manifold_dimensions, final_cost_rLM; color = robust_color, label = "RLM")
